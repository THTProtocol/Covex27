...
const COVENANTS = [
  { id:'flipcoin', name:'FlipCoin', category:'Skill Contests', covenant_type:'p2sh-covenant', tier:'PRO', tier_kas:500, amount_kaspa:500.0, amount_sompi:50000000000, tx_id:'70122ad3eb35bc8d7b29a3e8d9f52c7e4a1b6d0f8e3c9a7b5d2f4e6a8c0d3f7b2', script_hash:'3c9a7b5d2f4e6a8c0d3f7b270122ad3eb', creator_addr:'kaspatest:pxf3txjsl2qk98asd7f3h2k1m9d6c0v7b5n4p8z6q', desc:'Provably fair coin flip with winner-takes-all payout. Powered by SilverScript.' },
  { id:'rankedmatch', name:'RankedMatch', category:'Skill Contests', covenant_type:'p2sh-covenant', tier:'MAX', tier_kas:1000, amount_kaspa:1500.0, amount_sompi:150000000000, tx_id:'7220235db84ec8a97b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a', script_hash:'5d6e7f8a9b0c1d2e3f4a7220235db84e', creator_addr:'kaspatest:pq2k8asd7f3h2k1m9d6c0v7b5n4p8z6qpxf3txj', desc:'Professional 1v1 competitive matchmaking with crypto stakes.' },
  ...
  { id:'priceoracle', name:'PriceOracle', category:'Predictive Markets', covenant_type:'p2sh-covenant', tier:'MAX', tier_kas:1000, amount_kaspa:2000.0, amount_sompi:200000000000, tx_id:'b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a', script_hash:'2e3f4a5b6c7d8e9f0ab2c3d4e5f6a7b', creator_addr:'kaspatest:pq8z6qpxf3txjsl2qk8asd7f3h2k1m9d6c0', desc:'Real-time asset price settlement by cryptographic oracle signatures.' },
  { id:'binarybet', name:'BinaryBet', category:'Predictive Markets', covenant_type:'generic-covenant', tier:'PRO', tier_kas:500, amount_kaspa:750.0, amount_sompi:75000000000, tx_id:'c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b', script_hash:'4a5b6c7d8e9f0a1bc3d4e5f6a7b8c9d', creator_addr:'kaspatest:pq1m9d6c0v7b5n4p8z6qpxf3txjsl2qk8', desc:'Simple yes/no binary outcome prediction market.' },
  { id:'multisigescrow', name:'MultiSigEscrow', category:'Escrow & Custody', covenant_type:'multi-sig-covenant', tier:'PRO', tier_kas:500, amount_kaspa:3000.0, amount_sompi:300000000000, tx_id:'e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d', script_hash:'6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f', creator_addr:'kaspatest:pq7f3h2k1m9d6c0v7b5n4p8z6qpxf3txj', desc:'M-of-N multisig escrow for secure, trust-minimized trades.' },
  ...
  { id:'elimination', name:'EliminationBracket', category:'Tournaments', covenant_type:'p2sh-covenant', tier:'MAX', tier_kas:1000, amount_kaspa:5000.0, amount_sompi:500000000000, tx_id:'b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a', script_hash:'0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6', creator_addr:'kaspatest:pq3txjsl2qk8asd7f3h2k1m9d6c0v7b5', desc:'Single-elimination tournament bracket with automated progression.' },
  { id:'governancevote', name:'GovernanceVote', category:'Governance', covenant_type:'generic-covenant', tier:'PRO', tier_kas:500, amount_kaspa:1000.0, amount_sompi:100000000000, tx_id:'e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d', script_hash:'2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a', creator_addr:'kaspatest:pq4p8z6qpxf3txjsl2qk8asd7f3h2k1m', desc:'On-chain governance with delegated voting power and quadratic voting.' },
  { id:'flashloan', name:'FlashLoan', category:'Flash Covenants', covenant_type:'extended-covenant', tier:'MAX', tier_kas:1000, amount_kaspa:10000.0, amount_sompi:1000000000000, tx_id:'a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f', script_hash:'4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f', creator_addr:'kaspatest:pq6h2k1m9d6c0v7b5n4p8z6qpxf3txjs', desc:'Borrow and repay within a single block execution. Zero-risk arbitrage protocol.' },
...
app.get('/api/covenants', (req, res) => {
  ...
  const order = { MAX: 0, PRO: 1, CREATOR: 2, FREE: 3 };
