...
<style>{css}
  ...
  <div class="glass-panel" style="border-color:{tier_color};">
    ...
    <div class="full-disclosure">
      ...
      <div class="field-row"><span>Oracle Proof / Sig</span><span>If the outcome is oracle-attested, the disclosed resolver co-signs off-chain and that signature is checked on-chain at unlock (not trustless); on-chain covenants need no oracle. See covenant detail for sig + message.</span></div>
