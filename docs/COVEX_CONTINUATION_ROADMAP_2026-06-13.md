...
10. **D1 - On-chain oracle-sig verification.** The headline of covenant activation: moves trust from "oracle is honest about payout" to "the chain enforced that the external resolver signed this." Sits atop A1+B1+B3.
...
- **Reality check:** Kaspa has no pairing precompile, so full on-chain Groth16 is **not** achievable at Toccata. The achievable guarantee is **on-chain Schnorr verification** that the external resolver signed the outcome.
