...
export const ZK_CIRCUIT_TYPES = [
  ...
  // ═══════════════════════════════════════════
  { id: 'chess_v1', name: 'Chess (FIDE)', description: 'Hybrid: circom+wasm+r1cs ready (~76k constraints); Groth16 zkey ceremony in progress (pot17). Oracle verifies Groth16 when chess_v1_vkey.json exists, else attestation fallback. Witnessed attack model. Artifacts in zk/games/chess/.', circuit: 'chess_v1', accent: '#49EACB', category: 'game', reality: 'hybrid' },
  ...
  { id: 'connect4_v1', name: 'Connect Four', description: 'Full ZK: Groth16 proof per legal drop (7×6 gravity + witnessed 4-in-a-row). MiMC7 board hash. Falls back to oracle attestation. Artifacts in zk/games/connect4/.', circuit: 'connect4_v1', accent: '#3B82F6', category: 'game', reality: 'full-zk', artifacts: true },
  ...
  { id: 'tictactoe_v1', name: 'Tic-Tac-Toe', description: 'Full ZK: Groth16 proof per legal move (3×3, full in-circuit win/draw). MiMC7 board hash. Falls back to oracle attestation. Artifacts in zk/games/tictactoe/.', circuit: 'tictactoe_v1', accent: '#EC4899', category: 'game', reality: 'full-zk', artifacts: true },
  ...
  { id: 'nullifier_set', name: 'Nullifier Set Proof', description: 'Hybrid: nullifier derivation embedded in privacy_mixer_v1; oracle DB tracks spent nullifiers. Standalone circom source in zk/nullifier/ (not yet compiled to zkey).', circuit: 'nullifier_generic', accent: '#FB923C', category: 'crypto', reality: 'hybrid' },
  ...
  { id: 'timelock_absolute', name: 'Absolute Timelock Proof', description: 'Full ZK: Groth16 proof that current_daa >= lock_threshold. Maps to Kaspa DAA timelock covenant unlock. Artifacts in zk/timelock/.', circuit: 'timelock_abs', accent: '#F97316', category: 'ownership', reality: 'full-zk', artifacts: true },
