...
export const ZK_CIRCUIT_TYPES = [
  ...
  // ═══════════════════════════════════════════
  { id: 'chess_v1', name: 'Chess (FIDE)', description: 'Complete FIDE rules enforced by oracle: castling, en passant, checkmate, stalemate, 50-move, threefold repetition. Real per-turn timer - only active player clock decrements. <30s = red; zero = auto-resolve + oracle payout.', circuit: 'chess_v1', accent: '#49EACB', category: 'game', reality: 'oracle-attested' },
