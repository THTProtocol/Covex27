...
export const ZK_CIRCUIT_TYPES = [
  ...
  // ═══════════════════════════════════════════
  { id: 'chess_v1', name: 'Chess (FIDE)', description: 'Hybrid (default, fast) or Full ZK mode (stronger security). Public proving_mode (0=Hybrid: chess.js supplies candidates+attacks for end conditions/king safety; 1=Full ZK: more exhaustive witness gen, proof commits to higher assurance). Core move legality, board transition, post-move king safety, timers, repetition proven in-circuit either way. Groth16 artifacts (~76k constraints) in zk/games/chess/. Oracle supports both via the same circuit + mode in public signals. Fast Hybrid target <15s proofs. Select mode when configuring the covenant. Use cases: p2p skill matches with real stakes + per-turn clocks on Kaspa. See zk/games/chess/CHESS_PROVING_MODES.md.', circuit: 'chess_v1', accent: '#49EACB', category: 'game', reality: 'hybrid', proving_modes: [0,1] },
  ...
  { id: 'poker_vrf_deal', name: 'Poker VRF Card Deal Proof', description: 'VRF variant: prove dealt cards came from committed fair shuffle (no dealer bias). Reality: oracle-attested (VRF planned full-zk). Use cases: provably fair Kaspa poker deals. (vision §4.3 shared VRF, §4.1)', circuit: 'poker_vrf_deal', accent: '#E8AF34', category: 'game', variant: true, reality: 'oracle-attested' },
  ...
  { id: 'vrf_random', name: 'Committed Random (VRF)', description: 'Oracle-path (no artifacts yet): verifiable random function - proves output was correctly derived from seed + secret key. Fair coin flips, card shuffles without trusted dealer. VRF artifacts planned. Reality: oracle-attested. Use cases: all fair randomness in Kaspa games/DeFi. (vision §4.1)', circuit: 'vrf_generic', accent: '#EC4899', category: 'crypto', reality: 'oracle-attested' },
  ...
  { id: 'timelock_relative', name: 'Relative Timelock Proof', description: 'Oracle-path (no artifacts yet): prove N blocks passed since reference point. Dispute periods, cooldown windows. High priority for artifacts. Reality: oracle-attested. Use cases: relative locks in Kaspa channels/state. (vision §4.2)', circuit: 'timelock_rel', accent: '#F97316', category: 'kaspa', variant: true, reality: 'oracle-attested' },
  ...
  { id: 'collateral_ltv', name: 'LTV / Health Factor Proof', description: 'Prove exact LTV or health factor from committed collateral + oracle price. Reality: hybrid. Use cases: dynamic collateral covenants on Kaspa. (vision §4.4)', circuit: 'collateral_ltv', accent: '#DC2626', category: 'defi', variant: true, reality: 'hybrid' },
  ...
  { id: 'escrow_2party', name: '2-Party Escrow', description: 'Oracle-attested: timelocked escrow with mutual release or timeout refund. Oracle dispute resolution option. Uses timelock + range proofs. Reality: oracle-attested. Use cases: simple Kaspa escrow deals. (vision §4.4)', circuit: 'escrow_2party', accent: '#38BDF8', category: 'defi', reality: 'oracle-attested' },
  ...
  { id: 'auction_clearing', name: 'Auction Clearing Price Proof', description: 'Prove uniform clearing price from ordered bids + reserve. Reality: hybrid. Use cases: fair price discovery in Kaspa auctions. (vision §4.4)', circuit: 'auction_clear', accent: '#A78BFA', category: 'defi', variant: true, reality: 'hybrid' },
