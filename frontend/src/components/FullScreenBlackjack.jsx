  ...
  return (
    ...
    >
      ...
      <div className="h-12 sm:h-14 border-b border-white/10 light:border-slate-300/70 flex items-center justify-between gap-2 px-3 sm:px-4 text-sm bg-black/60 light:bg-white/80 backdrop-blur-xl shrink-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div
            ...
            title="The pot settles when Covex re-derives the winner from the publicly replayable signed move log (anyone can recompute) and co-signs the release; the chain still requires the winning player's own signature via the redeem script. The chain-enforced, no-Covex-key path is rolling out."
          >
            CO-SIGNED RELEASE
          </div>
          <button
      ...
      <div className="h-10 border-t border-white/10 light:border-slate-300/70 text-[9px] sm:text-[10px] text-gray-500 light:text-slate-600 flex items-center justify-center font-mono px-3 text-center shrink-0">
        CO-COMMITTED DECK (COMMIT-REVEAL) · DETERMINISTIC MOVE-LOG REPLAY · CO-SIGNED RELEASE · PAYOUT ENFORCED ON-CHAIN BY THE REDEEM SCRIPT
      </div>
    </div>
  );
}
