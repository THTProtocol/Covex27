...
const ROUTES = [
  ...
  { p: '/readme', t: 'Readme', d: 'How Covex works, honestly: index every covenant, redeem any P2SH covenant from your own wallet, and verify the disclosed keys, vkeys, and treasury for yourself.' },
  { p: '/docs', t: 'API Docs', d: 'The Covex public API: paginated covenant discovery, search, per-covenant lifecycle, address portfolios, and live health and honesty signals.' },
