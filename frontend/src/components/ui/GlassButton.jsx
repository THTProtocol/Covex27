...
// Ultra-optimized WebP normal map from 21st.dev reference
// Source: easemize/apple-tahoe-liquid-glass-button
  ...
  return (
    <>
      {/* INVISIBLE SVG FILTER DEFINITION
          primitiveUnits="objectBoundingBox" allows the 1x1 displacement map to
          seamlessly stretch and scale to fit ANY button size automatically.
      */}
      ...
      <button
        ...
        {...props}
      >
        {/* ISOLATED BACKGROUND LENS — must remain empty to prevent text ghosting */}
