...
const REALITY_EXPLAIN = {
  'on-chain': 'The Kaspa chain enforces this directly — fully trustless. Your own wallet redeems with the published script; Covex is not in the path.',
  'full-zk': 'A real Groth16 proof gates the spend — trustless: a valid proof is the only key, verified fail-closed.',
