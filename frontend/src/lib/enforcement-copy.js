...
// frozen). There is NO "chain-enforced ZK" tier: no deployed circuit's proof is bound to a
...
// circuit beyond the 4 self-contained ones is full-zk (verified OFF-CHAIN by an external
// resolver). Every word here is load-bearing. Do not soften "consensus-enforced",
// "co-signed", "off-chain", or the explicit carve-out that full-zk is NOT on-chain
// trustless because Kaspa lacks a pairing verifier. No em dashes.
