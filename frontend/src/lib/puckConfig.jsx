...
export const STARTER_TEMPLATES = [
  ...
  },
  {
    ...
    premium: true,
    match: ['subscription', 'membership', 'recurring', 'pass', 'saas'],
    desc: 'Recurring membership tiers, a benefits grid, and an on-chain enforcement badge.',
    data: {
      root: ROOT({ backgroundPreset: 'kaspa-hero' }),
      content: [
        blk('HeroImage', { backgroundImageUrl: '', overlayOpacity: '0.55', title: '{{name}}', subtitle: 'Join in your own wallet. Non-custodial, on-chain, transparent. {{total_locked}} committed on {{network}}.', ctaLabel: 'Become a member', ctaAction: 'spend', accentColor: '#49EACB', alignment: 'center' }),
        blk('EnforcementBadge', { note: 'How this membership is enforced' }),
        blk('PricingTier', { columns: '3', tiers: [{ name: 'Monthly', price: '10', cadence: 'KAS / month', featured: 'no', glow: 'builder', perks: 'Full access\nNon-custodial\nCancel anytime', ctaLabel: 'Join', ctaAction: 'spend', amount: '10' }, { name: 'Annual', price: '100', cadence: 'KAS / year', featured: 'yes', glow: 'pro', perks: 'Full access\nTwo months free\nPriority support', ctaLabel: 'Join', ctaAction: 'spend', amount: '100' }, { name: 'Lifetime', price: '400', cadence: 'KAS once', featured: 'no', glow: 'max', perks: 'Forever access\nAll future perks\nFounder badge', ctaLabel: 'Join', ctaAction: 'spend', amount: '400' }] }),
        blk('FeatureGrid', { columns: '3', features: [{ icon: 'Zap', headline: 'Recurring on-chain', description: 'Every renewal settles on Kaspa and is disclosed and verifiable on the explorer.' }, { icon: 'ShieldCheck', headline: 'Non-custodial', description: 'You sign each payment in your own wallet. Keys never leave your device.' }, { icon: 'Lock', headline: 'You are in control', description: 'Nothing auto-charges without your signature. Cancel on your terms.' }] }),
        blk('StatRow', { stats: [{ label: 'Members', value: '{{tx_count}}' }, { label: 'Committed', value: '{{total_locked}}' }, { label: 'Status', value: '{{status}}' }] }),
        blk('Accordion', { title: 'Frequently asked', items: [{ q: 'How does billing work?', a: 'You authorize each payment in your own wallet on the disclosed cadence. Nothing auto-charges without your signature. See the enforcement badge on this page.' }, { q: 'Is it non-custodial?', a: 'Yes. You sign in your own wallet; keys never leave your device.' }] }),
        blk('Footer', { text: '{{name}} · Membership covenant on Kaspa', showNetwork: 'yes' }),
      ],
    },
  },
  {
