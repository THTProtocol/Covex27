...
export const PAGE_BLOCKS = [
  ...
  },
  {
    id: 'OddsBar',
    name: 'Odds bar',
    oneLiner: 'YES vs NO odds as a split bar driven by live pool data.',
    category: 'Live data',
    insertHint: INSERT_HINT,
  },
  {
    id: 'OddsHighlightCard',
    name: 'Odds highlight card',
    oneLiner: 'Large card showing the leading side and its implied odds.',
    category: 'Live data',
    insertHint: INSERT_HINT,
  },
  {
