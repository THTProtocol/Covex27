  ...
  return (
    <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="grid sm:grid-cols-2 gap-3 mb-6">
        {[
          ['Networks', <>The <code className="text-white">network=</code> query accepts <span className="text-white">testnet-12</span> (default), <span className="text-white">testnet-10</span>, and <span className="text-white">mainnet</span>. Mainnet is configured and indexing-ready but returns <span className="text-white">0 covenants until the Toccata upgrade (June 30, 2026)</span> activates on-chain covenants - that is expected, not an error.</>],
