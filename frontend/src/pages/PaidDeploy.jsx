    ...
    <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 animate-in fade-in duration-300">
      ...
      >
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="text-right text-xs text-gray-400 font-mono">{paidTier} • TN12</div>
        </div>
      </div>
        ...
        <div className="bg-[#0a0a0a]/95 border border-[#1f1f1f] rounded-2xl p-6 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            {[
              ...
              >
                <opt.icon size={18} className={resolutionMode === opt.mode ? 'text-[#49EACB] mb-2' : 'text-gray-400 mb-2'} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 mb-4">
          <div className="lg:col-span-3 bg-[#0a0a0a]/95 border border-[#1f1f1f] rounded-2xl p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <a href="http://localhost:5173" target="_blank" className="text-xs text-[#49EACB] hover:underline flex items-center gap-1">Open Studio <ExternalLink size={11} /></a>
            </div>
            <textarea
              value={customUICode}
            ...
            />
            <p className="text-[10px] text-gray-400 mt-2">The UI renders on your public covenant page. Test on mobile too.</p>
          </div>
