      ...
      <div className="bg-[#0a0a0a] border border-[#1f1f1f] rounded-3xl p-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          {[
            ...
            { icon: Link2, title: 'Oracles', text: 'If your covenant needs external data (sports, weather, stock), choose Custom Oracle or Standard Oracle mode and supply a key. The Covex oracle produces SHA256-signed attestations. ZK resolution mode exists as an aspirational design target — only Merkle Membership has a working proof pipeline today.' },
