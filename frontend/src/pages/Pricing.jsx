...
const TIERS = [
  ...
  },
  {
    ...
    name: 'Creator',
    price: 100,
    desc: 'Deploy 1 custom interactive covenant with basic visibility.',
    features: [
      'Everything in Free',
  ...
  },
  {
    ...
    name: 'PRO',
    price: 500,
    desc: 'Deploy 1 custom interactive covenant with good visibility and featured placement.',
    features: [
  ...
  },
  {
    ...
    name: 'MAX',
    price: 1000,
    desc: 'Deploy 1 custom interactive covenant with best visibility and top Explorer placement.',
    features: [
      'Everything in PRO',
      '1 custom interactive covenant',
