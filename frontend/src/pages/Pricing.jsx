...
const TIERS = [
  ...
  },
  {
    ...
    missing: ['No priority placement', 'No featured visibility'],
  },
  {
    id: 'priority',
    name: 'Priority',
    subtitle: 'Featured Visibility',
    priceKAS: 500,
    period: 'one-time',
    color: 'border-kaspa-gold/30 bg-kaspa-gold/5',
    accent: '#E8AF34',
    popular: true,
    desc: 'Priority visibility and featured placement. Your covenant appears before standard listings with enhanced discovery features.',
    features: [
      'Everything in Creator',
      'Priority registry placement',
      'Featured visibility on homepage',
  ...
  },
  {
    ...
    accent: '#A855F7',
    popular: false,
    desc: 'Maximum visibility with top row placement and premium branding. Dedicated indexing priority for enterprise-grade covenant applications.',
    features: [
      'Everything in Priority',
      'Top row placement on explorer',
      'Premium branding options',
      'Custom domain embedding',
      'Dedicated indexer priority',
      'Priority node queue access',
