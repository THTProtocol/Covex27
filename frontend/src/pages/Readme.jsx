        ...
        <div className="grid lg:grid-cols-2 gap-6 items-start">
          <div>
            <p className="text-sm text-gray-300 leading-relaxed mb-4">
              ...
              (snarkjs against the served vkey: no proof body, no missing key, no soft-pass). Only when a proof genuinely verifies does a
