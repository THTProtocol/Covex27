  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-10 space-y-8">
      ...
      <div className="glass-panel p-8">
        <h1 className="text-2xl font-semibold text-white tracking-tight">Terms and Conditions</h1>
      ...
      <div className="glass-panel p-8 space-y-8 text-sm text-gray-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">1. What Covex Is (and Is Not)</h2>
          <p>
            Covex is software: a read-only Kaspa BlockDAG explorer, an indexer of publicly available
            on-chain data, and an optional user-interface generator. <strong className="text-white">Covex is not the operator,
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">2. Non-Custodial and Recoverable Without Covex</h2>
          <p>
          ...
          <p>
            ...
            open-source recovery tool in the project repository (<span className="font-mono text-gray-200">tools/recover-covenant.mjs</span>)
            reconstructs the redeem script from chain data alone. <strong className="text-white">If Covex disappears, your funds remain
        ...
        {/* 3. Indexing + UI */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">3. Covenant Indexing and UI Generation</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">4. Skill-Based Interactions and Games</h2>
          <p>
            Any games surfaced through the Platform (e.g. chess, connect-four, tic-tac-toe) are
            <strong className="text-white"> games of skill played peer-to-peer between participants</strong>. Covex is not a
        ...
        {/* 5. Eligibility */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">5. Eligibility</h2>
        ...
        {/* 6. Payments */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">6. On-Chain Payments</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">7. User Responsibility</h2>
        ...
        {/* 9. No advice */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">9. No Financial, Investment, Legal, or Tax Advice</h2>
          <p>
        ...
        {/* 10. Privacy and data */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">10. Privacy and Data</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">11. Third-Party Services and Dependencies</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">12. Intellectual Property and Open Source</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">13. Disclaimer of Warranty</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">14. Limitation of Liability</h2>
          <p>
        ...
        {/* 15. Indemnification */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">15. Indemnification</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">16. Governing Law and Disputes</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">17. Severability and Entire Agreement</h2>
          <p>
        ...
        {/* 18. Changes */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">18. Changes to These Terms</h2>
          <p>
        ...
        {/* 19. Contact */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">19. Contact</h2>
          <p>
