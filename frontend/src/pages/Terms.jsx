      ...
      <div className="glass-panel p-8 space-y-8 text-sm text-gray-300 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside space-y-2 pl-2 text-gray-200">
            ...
            <li>Labels each covenant's enforcement reality honestly (on-chain, oracle-attested, or metadata-only) and never implies more enforcement than the chain provides.</li>
        ...
        {/* 8. No advice */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">8. No Financial, Investment, Legal, or Tax Advice</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">9. Disclaimer of Warranty</h2>
          <p>
        ...
        {/* 11. Indemnification */}
        <section className="space-y-3">
          <h2 className="text-base font-semibold text-white">11. Indemnification</h2>
          <p>
