...
const CASES = [
  ...
  { name: "auction_clearing", proof: "auction_clearing_proof.json", verify: "node verify_auction_clearing.js auction_clearing_proof.json", circuit_type: "auction_clearing", optional: true },
  { name: "poker_vrf_deal", proof: "poker_vrf_deal_proof.json", verify: "node verify_poker_vrf_deal.js poker_vrf_deal_proof.json", circuit_type: "poker_vrf_deal", optional: true },
  { name: "collateral_ltv", proof: "collateral_ltv_proof.json", verify: "node verify_collateral_ltv.js collateral_ltv_proof.json", circuit_type: "collateral_ltv", optional: true },
  { name: "loan_health", proof: "loan_health_proof.json", verify: "node verify_loan_health.js loan_health_proof.json", circuit_type: "loan_health", optional: true },
  { name: "financial_formula", proof: "financial_formula_proof.json", verify: "node verify_financial_formula.js financial_formula_proof.json", circuit_type: "financial_formula", optional: true },
  { name: "chess_ai_move", proof: "chess_ai_move_proof.json", verify: "node verify_chess_ai_move.js chess_ai_move_proof.json", circuit_type: "chess_ai_move", optional: true },
  { name: "election_feed", proof: "election_feed_proof.json", verify: "node verify_election_feed.js election_feed_proof.json", circuit_type: "election_feed", optional: true },
  { name: "verifiable_poker_solver", proof: "verifiable_poker_solver_proof.json", verify: "node verify_verifiable_poker_solver.js verifiable_poker_solver_proof.json", circuit_type: "verifiable_poker_solver", optional: true },
  { name: "multi_sig_gating", proof: "multi_sig_gating_proof.json", verify: "node verify_multi_sig_gating.js multi_sig_gating_proof.json", circuit_type: "multi_sig_gating", optional: true },
  { name: "anon_credential", proof: "anon_credential_proof.json", verify: "node verify_anon_credential.js anon_credential_proof.json", circuit_type: "anon_credential", optional: true },
  { name: "sorting_proof", proof: "sorting_proof_proof.json", verify: "node verify_sorting_proof.js sorting_proof_proof.json", circuit_type: "sorting_proof", optional: true },
  { name: "weather_feed", proof: "weather_feed_proof.json", verify: "node verify_weather_feed.js weather_feed_proof.json", circuit_type: "weather_feed", optional: true },
