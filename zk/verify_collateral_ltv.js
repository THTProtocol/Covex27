...
// frontend artifact (frontend/public/zk/collateral_ltv/) is the single source of truth;
...
const VKEY_CANDIDATES = [
    path.join(__dirname, "..", "frontend", "public", "zk", "collateral_ltv", "collateral_ltv_vkey.json"),
    path.join(__dirname, "collateral_ltv_vkey.json"),
];
