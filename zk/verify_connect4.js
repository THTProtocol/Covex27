...
async function main() {
    ...
    if (!proofFile) {
        console.log(JSON.stringify({ valid: false, error: "Usage: node verify_connect4.js <proof.json>" }));
        process.exit(1);
    }
    ...
    try {
        ...
        console.log(JSON.stringify({ valid, publicSignals, circuit: "connect4_v1" }));
    } catch (e) {
