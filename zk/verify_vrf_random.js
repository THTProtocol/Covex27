...
async function main() {
    ...
    if (!proofFile) {
        console.log(JSON.stringify({ valid: false, error: "Usage: node verify_vrf_random.js <proof.json>" }));
        process.exit(1);
    }
    ...
    try {
        ...
        console.log(JSON.stringify({ valid, publicSignals, circuit: "vrf_random" }));
    } catch (e) {
